...
interface Api {
    ...
    suspend fun getPosts(@Path("limit") limit: String , @Path("page") page: String ): Response<ApiResponseArray>

    @GET("products/{id}")
    suspend fun getPostDetails(@Path("id") id: String): Response<ApiResponse>
